...
export default function Main() {
    ...
    return (<main id="main">
            ...
            <svg ref={fallingStickmanRef} className={`falling-stickman ${fallingStickmanInView ? 'falling-stickman-animate' : ''}`} width="175" height="471" viewBox="0 0 175 471" fill="none"
                ...
                <path d="M101.304 329C88.8498 343.272 60.813 395.184 60.6679 468.649" stroke="black" stroke-width="8"
                      stroke-linecap="round"/>
                <path d="M95 189.5C128.667 182 190.4 134 168 2" stroke="black" stroke-width="8" stroke-linecap="round"/>
                <path d="M95 189.5C58.6667 181 -10.4 132.4 3.99999 6" stroke="black" stroke-width="8"
                      stroke-linecap="round"/>
                <path d="M101.5 328.5C127.667 299.833 178.4 274.6 172 403" stroke="black" stroke-width="8"
                      stroke-linecap="round"/>
            </svg>
