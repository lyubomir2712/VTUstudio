...
export default function SectionFive() {
    ...
    const { ref: cloudOneRef, inView: cloudOneInView } = useInView({ triggerOnce: false, threshold: 0.1 });
    const { ref: cloudTwoRef, inView: cloudTwoInView } = useInView({ triggerOnce: false, threshold: 0.1 });
    const { ref: contactListRef, inView: contactListInView } = useInView({ triggerOnce: false, threshold: 0.1 });
    const { ref: pirateShipRef, inView: pirateShipInView } = useInView({ triggerOnce: false, threshold: 0.1 });
    const { ref: questionMarkRef, inView: questionMarkInView } = useInView({ triggerOnce: false, threshold: 0.1 });
        ...
        <section id={"sectionFive"}>
            ...
            <svg ref={cloudOneRef} className={`cloud-one ${cloudOneInView ? 'cloud-one-animate' : ''}`} width="409"
                ...
                <path d="M87.0001 49C89 52 91.3483 54 93.5 55M141 34C141.512 35 142.6 37.2 143 40" stroke="black"
                      strokeLinecap="round"/>
                <path d="M105 213C-7.99997 241 -33 164 49.0001 130" stroke="black" strokeLinecap="round"/>
                <path d="M49.0001 130C-2.99999 95.9999 8.00001 49 87.0001 49" stroke="black" strokeLinecap="round"/>
                <path d="M87.0001 49C69.0088 8.868 120 -7.00004 141 34" stroke="black" strokeLinecap="round"/>
                <path d="M141 34C194 -24 290 1.99998 345 54" stroke="black" strokeLinecap="round"/>
                <path d="M345 54C382 34 430 77 377 95.9999" stroke="black" strokeLinecap="round"/>
                <path d="M377 96C439 96 403 173 317 164" stroke="black" strokeLinecap="round"/>
                <path d="M317 164C368 196 317 254 263 223" stroke="black" strokeLinecap="round"/>
                <path d="M105 213C49.0001 297 190 302 263 223" stroke="black" strokeLinecap="round"/>
                <path d="M137 133C124 152.667 112.6 188 171 172" stroke="black" strokeLinecap="round"/>
            ...
            <svg ref={cloudTwoRef} className={`cloud-two ${cloudTwoInView ? 'cloud-two-animate' : ''}`} width="658"
                ...
                <path d="M618 233C739 259 548 403 453 361" stroke="black" strokeLinecap="round"/>
                <path d="M453 361C436 438 323 443 323 350" stroke="black" strokeLinecap="round"/>
                <path d="M323 350C275 476 40.5 399.5 74.0997 340" stroke="black" strokeLinecap="round"/>
                <path d="M93.0001 150C-27.9445 20.29 -21.9656 269.11 65 334.063" stroke="black" strokeLinecap="round"/>
                <path d="M93.0001 150C105 78 204 50 275 94" stroke="black" strokeLinecap="round"/>
            ...
            <svg ref={contactListRef} className={`contact-list ${contactListInView ? 'contact-list-animate' : ''}`}
                ...
                <path d="M82 81H110" stroke="black" strokeLinecap="round"/>
                <path d="M82 361H110" stroke="black" strokeLinecap="round"/>
                <path d="M82 269H110" stroke="black" strokeLinecap="round"/>
                <path d="M82 176H110" stroke="black" strokeLinecap="round"/>
                <path d="M139 64H249" stroke="black" strokeLinecap="round"/>
                <path d="M167 193H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 159H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 176H277" stroke="black" strokeLinecap="round"/>
                <path d="M139 98H249" stroke="black" strokeLinecap="round"/>
                <path d="M139 81H249" stroke="black" strokeLinecap="round"/>
                <path d="M167 252H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 269H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 286H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 344H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 361H277" stroke="black" strokeLinecap="round"/>
                <path d="M167 378H277" stroke="black" strokeLinecap="round"/>
                ...
                <path d="M1.38606 367.417C1.38608 395.5 10.5 401.917 45.386 401.917" stroke="black"
                      strokeLinecap="round"/>
                <path d="M45.386 401.917H302.386" stroke="black" strokeLinecap="round"/>
                <path d="M333.385 362.917L333.33 72" stroke="black" strokeLinecap="round"/>
            ...
            <svg ref={pirateShipRef}
                ...
                <path d="M350 490C357.5 496 380 514 403.5 528" stroke="black" strokeLinecap="round"/>
                <path d="M210 523L207 506.5L204.214 491.179C204.103 490.565 204.574 490 205.198 490H350" stroke="black"
                      strokeLinecap="round"/>
                <path d="M808 511C619.5 535.7 420.5 536 403.5 528" stroke="black" strokeLinecap="round"/>
                <path
                ...
                <path d="M280.5 639C419.5 668 635 663 769.5 634.5" stroke="black" strokeLinecap="round"/>
                <path d="M808 511L909.634 492.035C910.746 491.827 911.582 493.03 911 494V494L811 523" stroke="black"
                      strokeLinecap="round"/>
                <path d="M534 354C551.33 445.199 544.168 492.225 544.5 532.5" stroke="black" strokeLinecap="round"/>
                <path d="M509 533C516.349 459.275 517.954 415.779 516 354" stroke="black" strokeLinecap="round"/>
                <path d="M499 354C490.287 438.995 483.334 478.313 471 532.5" stroke="black" strokeLinecap="round"/>
                <path d="M483.219 474H545.5" stroke="black" strokeLinecap="round"/>
                <path d="M490 434H544.25" stroke="black" strokeLinecap="round"/>
                <path d="M494.5 399C512.18 399 522.82 399 540.5 399" stroke="black" strokeLinecap="round"/>
                <path d="M309 355.5C373.333 352.5 571.6 351.8 666 359" stroke="black" strokeLinecap="round"/>
                <path d="M666 359C660.333 328 648.6 248 647 176" stroke="black" strokeLinecap="round"/>
                <path d="M309 355.5C317 339.167 335.6 283.2 326 176" stroke="black" strokeLinecap="round"/>
                <path d="M495 8V79V154" stroke="black" strokeLinecap="round"/>
                <path d="M684 154L495 79" stroke="black" strokeLinecap="round"/>
                <path d="M288 154L495 79" stroke="black" strokeLinecap="round"/>
                <path d="M684 154H495H288" stroke="black" strokeLinecap="round"/>
                <path d="M288 176H684" stroke="black" strokeLinecap="round"/>
                <path
                ...
                <path
                    ...
                    stroke="black" strokeLinecap="round"/>
                <path d="M660 8.75403V43.754V78.754" stroke="black" strokeLinecap="round"/>
                <path
                    d="M495 8.75401C510.658 34.1611 544.5 32.2539 563 23.254C607.964 1.37967 639.429 -3.89438 660 8.75401"
                    stroke="black" strokeLinecap="round"/>
                <path d="M553 63.5L598.5 37" stroke="black" strokeLinecap="round"/>
                <path d="M599.152 36.25C598.622 36.3162 599.652 38.1334 599.652 36" stroke="black" strokeWidth="3"
                      strokeLinecap="round"/>
                <path d="M598.586 63.25C597.135 63.25 598.836 64.8507 598.836 63" stroke="black" strokeWidth="3"
                      strokeLinecap="round"/>
                <path d="M552.685 36C551.009 36.1862 552.935 37.7478 552.935 36" stroke="black" strokeWidth="3"
                      strokeLinecap="round"/>
                <path
                ...
                <path d="M692.067 398C690.378 399.833 687 404.2 687 407C690.6 404.6 691.878 400 692.067 398Z"
                      stroke="black" strokeLinecap="round"/>
                <path d="M692.5 399.5C693.667 394.333 699.6 385.4 712.8 391" stroke="black" strokeLinecap="round"/>
                <path
                    ...
                    stroke="black" strokeLinecap="round"/>
                <path d="M710.5 365L688 382M684 368.5L711.5 379" stroke="black" strokeLinecap="round"/>
                <path d="M688 382.125V382" stroke="black" strokeWidth="2" strokeLinecap="round"/>
                <path d="M712.125 379C712.111 379.115 712.084 379.083 712 379.125" stroke="black" strokeWidth="2"
                      strokeLinecap="round"/>
                <path d="M711.125 364.5C711.01 364.514 711.042 364.541 711 364.625" stroke="black" strokeWidth="2"
                      strokeLinecap="round"/>
                <path d="M684.125 368.5H684" stroke="black" strokeWidth="2" strokeLinecap="round"/>
                <path
                ...
                <path
                    ...
                    stroke="black" strokeLinecap="round"/>
                <path d="M913 711.834C929.667 705.168 969 695.834 993 711.834" stroke="black" strokeLinecap="round"/>
                <path d="M827 757C845 762.333 887.4 769.8 913 757" stroke="black" strokeLinecap="round"/>
                <path d="M718 714.834C736.667 708.168 781.2 698.834 810 714.834" stroke="black" strokeLinecap="round"/>
                <path d="M606 764C618 770 652.4 778.4 694 764" stroke="black" strokeLinecap="round"/>
                <path d="M495 733.718C509.667 726.385 548.2 716.118 585 733.718" stroke="black" strokeLinecap="round"/>
                <path d="M335 772C345.667 782.667 378.6 797.6 425 772" stroke="black" strokeLinecap="round"/>
                <path d="M225 742.628C239.667 731.961 275.8 715.028 303 732.628" stroke="black" strokeLinecap="round"/>
                <path d="M91 725.5C104.333 727.5 138.5 735.4 162.5 721" stroke="black" strokeLinecap="round"/>
