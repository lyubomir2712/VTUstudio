...
export default function SectionFour() {
    ...
    useEffect(() => {
        handleSvgClassChange('pensil-jet', pensilJetInView, scrollDirection);
    }, [pensilJetInView, scrollDirection]);
    ...
    return (
        <section id={"sectionFour"}>
            ...
            <svg ref={pensilJetRef}
                 className={`pensil-jet ${svgAnimation['pensil-jet'] ? 'pensil-jet-animate' : ''}`}  width="80" height="145" viewBox="0 0 80 145" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
