...
function SectionThree() {
    ...
    return (
        <section id="sectionThree">
            ...
            <svg className={"section-three-border"} width="958" height="546" viewBox="0 0 958 546" fill="none"
            ...
            <svg className={"painter-stickman"} width="951" height="689" viewBox="0 0 951 689" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg className={"section-three-cloud"} width="572" height="270" viewBox="0 0 572 270" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={"section-three-cloudTwo"} width="640" height="371" viewBox="0 0 640 371" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={"section-three-bird"} width="493" height="192" viewBox="0 0 493 192" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg className={"section-three-bird-two"} width="639" height="166" viewBox="0 0 639 166" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg className={"section-three-mini-cloud"} width="235" height="103" viewBox="0 0 235 103" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className={"section-three-mini-cloud-two"} width="227" height="82" viewBox="0 0 227 82" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
